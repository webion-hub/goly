class SettingsModel  {
  ...
  SettingsModel({this.privateGoalsByDefault = true, this.privateDescriptionsByDefault = true, this.privateAccount = false});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['privateDescriptionsByDefault'] = privateDescriptionsByDefault ?? 'true';
