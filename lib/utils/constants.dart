...
class Constants {
  ...
  static const pagePadding = EdgeInsets.symmetric(horizontal: 10.0, vertical: 10.0);
  ...
  static final List<CategoryModel> defaultCategories = [
    CategoryModel(id: const Uuid().v1(), name: 'Financial', private: false, privateDescription: false),
    CategoryModel(id: const Uuid().v1(), name: 'Career', private: false, privateDescription: false),
    CategoryModel(id: const Uuid().v1(), name: 'Spiritual', private: false, privateDescription: false),
    CategoryModel(id: const Uuid().v1(), name: 'Personal life', private: false, privateDescription: false),
    CategoryModel(id: const Uuid().v1(), name: 'Health & Fitness', private: false, privateDescription: false),
    CategoryModel(id: const Uuid().v1(), name: 'Familial', private: false, privateDescription: false),
  ];
}
